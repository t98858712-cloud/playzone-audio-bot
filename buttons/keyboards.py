...
from links.urls import WEBSITE_PLAYZONE, FACEBOOK_PLAYZONE, INSTAGRAM_PLAYZONE, THREADS_PLAYZONE
from database.operations import get_setting

def user_main_keyboard(lang: str = "ar") -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        [[KeyboardButton(_t("btn_guide", lang)), KeyboardButton(_t("btn_links", lang))], [KeyboardButton(_t("btn_add_group", lang))]],
...
def admin_main_keyboard(lang: str = "ar") -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("📢 الإذاعة والتواصل", callback_data="adm_bc_menu"), InlineKeyboardButton("👥 إدارة المستخدمين", callback_data="adm_users_menu")],
...
def admin_users_menu(lang: str = "ar") -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📋 أحدث المنضمين", callback_data="adm_users"), InlineKeyboardButton("🔎 استعلام عن (ID)", callback_data="adm_user_info_prompt")],
...
def admin_security_menu(lang: str = "ar") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup([
        [maint_btn], [hilltop_btn], [adsterra_btn], 
        [InlineKeyboardButton("🔄 تحديث مكتبة المحرك", callback_data="adm_update_dlp"), InlineKeyboardButton("🍪 إرشادات الكوكيز", callback_data="adm_cookie_guide")],
        [InlineKeyboardButton("🗜️ تحسين القاعدة", callback_data="adm_vacuum_db"), InlineKeyboardButton("🧹 تنظيف التخزين المؤقت", callback_data="adm_clean")],
...
def admin_cancel_action_keyboard(lang: str = "ar") -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([[InlineKeyboardButton("❌ إلغاء الإجراء الحالي", callback_data="adm_cancel_action")]])
