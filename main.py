...
from database.operations import load_banned_users, _cleanup_old_downloads_sync, parse_admin_ids
...
async def post_init(app: Application):
    ...
    try:
        ...
        for admin_id in parse_admin_ids():
            ...
            except Exception as e: logger.warning(f"فشل تعيين أوامر الإدارة للمدير {admin_id}: {e}")
...
def main():
    ...
    logger.info("🚀 تم تشغيل البوت بنظام الإدارة المؤسسية (Enterprise Control Center) بعد التقسيم.")
