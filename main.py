...
async def post_init(app: Application):
    # 🚀 التحديث الأساسي: ربط وإطلاق عمال الجدولة الفعالين مباشرة داخل الـ Active Event Loop
    await TaskOrchestrator.start()
    ...
    try:
        ...
        logger.warning(f"فشل تهيئة القوائم والأوامر: {e}")
