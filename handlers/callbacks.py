...
from utils.helpers import (
    ...
    get_thumbnail, get_largest_estimated_size, alert_admins_live, get_user_lang
)
    ...
    try:
        ...
        async with DOWNLOAD_SEMAPHORE:
            ...
            if mode in ["audio", "audio_pro"]:
                progress_data["text"] = _t("msg_converting_pro", lang) if mode == "audio_pro" else _t("msg_converting", lang)
