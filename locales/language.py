LANG_DICT = {
    "ar": {
        ...
        "btn_raw_audio": "🎵 الصوت الأصلي",
        "btn_raw_video": "🎬 الفيديو الأصلي",
        "btn_cancel": "❌ إلغاء",
        ...
        "msg_dl_finished": "⚙️ اكتمل التحميل، جاري التجهيز...",
