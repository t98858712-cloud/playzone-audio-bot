...
def get_cookie_file_for_url(url: str) -> Path | None:
    """بحث مباشر عن مسار الملف المطلوب بالضبط دون الاعتماد على فحص المجلد"""
    ...
    # فحص مباشر هل الملف المحدد موجود وصالح
    if selected and cookie_file_is_usable(selected):
        return selected
        
    # الرجوع لملف الكوكيز الاحتياطي إذا لم يتم العثور على المحدد
